...
<span class="mail1"><p><?=$v['username']."</p><p style='font-weight:normal;font-size:12px;color:#000;'>".$v['company_name']."</p><p style='font-weight:normal;font-size:12px;color:#808080;'>".$latest['message'];?></p></span>
...
setInterval(function(){ 
	...
	if(receiver_id!='' && sender_id!=''){getLatestChat(receiver_id,sender_id);}
}, 3500); 
});
...
function getLatestChat(receiver_id,sender_id){ 
