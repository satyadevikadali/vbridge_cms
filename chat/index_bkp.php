...
<?php 
/*$url ="https://vbridgehub.com/stgportal/login_userdetails_api.php?userid=".$sessionData['id'];
$ch = curl_init();
...
?>
                        ...
                        <input type="hidden" id="Sender_Name" value="<?=userProfileName; ?>">
                      ...
                      <input type="hidden" id="ReciverId_txt">    
                       <input type="hidden" id="SenderId_txt" class="sender_id" name="sender_id">     
						...
						<!--<textarea  name="message" placeholder="Type Message ..." class="form-control message" rows="2"></textarea> -->
						<input type="text" name="message" placeholder="Type Message ..." class="form-control message"> 
...
$.ajax({
  ...
  url:"https://vbridgehub.com/stgportal/chat/archieve.php",
  type:"POST",
...
$.ajax({
  ...
  url:"https://vbridgehub.com/stgportal/chat/restore.php",
  type:"POST",
  data:{receiver_id:receiver_id, sender_id:sender_id},
  success:function(response){
