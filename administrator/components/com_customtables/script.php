	...
	function postflight($type, $parent)
	{
		...
		if ($type == 'install')
		{
			...
			echo '<a target="_blank" href="https://joomlaboat.com" title="Custom Tables">
				<img src="components/com_customtables/assets/images/vdm-component.jpg"/>
				</a>';
		}
		// do any updates needed
		if ($type == 'update')
		{
			echo '<a target="_blank" href="https://joomlaboat.com" title="Custom Tables">
				...
				<h3>Upgrade to Version 1.0.76 Was Successful! Let us know if anything is not working as expected.</h3>';
		}
