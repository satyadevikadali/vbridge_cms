...
//              var styleInfo = _this.context.invoke('editor.currentStyle');
              var styleInfo = {"font-family":"Montesarrat, sans-serif","font-size":"14", "line-height":"23.0333px", "list-style-type":"disc","text-align":"left"};
      ...
      Buttons.prototype.updateCurrentStyle = function ($container) {
          ...
          if (styleInfo['font-family']) {
              ...
              $cont.find('.note-current-fontname').text('Montesarrat').css('font-family', 'Montesarrat');
          }
