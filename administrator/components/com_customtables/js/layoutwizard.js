...
function loadFieldsData(tableid)
{
	...
	var url=websiteroot+"/administrator/index.php?option=com_customtables&view=api&frmt=json&task=getfields&tableid="+tableid;
...
function updateFieldsBox()
{
	...
	if(current_layout_type!==5 && current_layout_type!==0)
	{
