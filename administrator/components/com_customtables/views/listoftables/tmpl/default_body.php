...
<?php foreach ($this->items as $i => $item): ?>
	...
	<tr class="row<?php echo $i % 2; ?>">
		...
		<td class="nowrap">
			<div class="name">
				<?php if ($canDo->get('core.edit')): ?>
					<a href="<?php echo $edit; ?>&id=<?php echo $item->id; ?>"><?php echo $this->escape($item->tabletitle); ?></a>
					<?php if ($item->checked_out): ?>
		...
		<td class="hidden-phone">
			<?php echo '<a href="'.JURI::root(true).'/administrator/index.php?option=com_customtables&view=listoffields&tableid='.$item->id.'">Fields ('.$item->fieldcount.')</a>'; ?>
		</td>
