...
.line h5{width:25%;margin-top:-10px;margin-left:40%;background:white;padding-left:5px;color: #606060;}
</style>
<?php
...
$Logged_sender_id = $sender_id;  
 $sql = "SELECT *,DATE_FORMAT(message_date_time, '%Y-%m-%d') as dOfChat FROM chat where `sender_id`= '$sender_id' AND `receiver_id` = '$receiver_id' OR `sender_id`= '$receiver_id' AND `receiver_id` = '$sender_id'"; 
